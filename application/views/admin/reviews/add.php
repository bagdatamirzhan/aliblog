<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
  ...
  <div class="row">
    <div class="col-lg-12">
      <h1 class="page-header">Добавить материал</h1>
      <p></p>
    </div>
  </div>
  <!--/.row-->
      ...
      <div class="panel panel-default">
        <div class="panel-body tabs">
          <ul class="nav nav-tabs">
            <li><a href="/keme/reviews">Мои материалы</a></li>
            <li class="active"><a href="/keme/reviews/add">Добавить материал</a></li>
          </ul>
          <div class="tab-content">
            ...
            <div class="mt-4">
              <ul class="nav nav-pills">
                ...
                <li class="nav-item">
                  <a class="nav-link disabled">Шаг 2 — Изображения</a>
                </li>
              </ul>
              <br>
              <form action="" method="post">
                ...
                <div class="row">
                  <div class="col-lg-6">
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" name="price" placeholder="Укажите стоимость" value="<?php echo !empty($user['price']) ? $user['price'] : ''; ?>" required>
                ...
                <div class="send-button">
                  <input type="submit" class="btn btn-primary" name="addSubmit" value="Сохранить и перейти к шагу 2">
                </div>
              </form>
